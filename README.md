...
- [x] 推し曲コーナー・イベントレポート・カレンダー・勝手にランキングのページ作成(デザインプレビュー段階)

**進行中**
- [ ] Vercel + Supabaseへの移行(投稿・投票機能をつなぎ込むための基盤整備)
- [ ] 推し曲コーナー・イベントレポート・勝手にランキングの投稿/投票機能を実際に動かす
- [ ] 基本的なスパム対策(即時公開のため)の実装
