...
const raw: Omit<Track, "sortDate">[] = [
  ...
  { group: "オーイシマサヨシ", type: "シングル", date: "2024.09", title: "Sea of Wonderland", slug: "sea-of-wonderland", image: "sea-of-wonderland" },
  { group: "オーイシマサヨシ", type: "シングル", date: "2024.11", title: "ギャンブリングホール", tieIn: "『凍牌』オープニングテーマ", slug: "gambling-hall", image: "gambling-hall" },
  { group: "オーイシマサヨシ", type: "シングル", date: "2025.01", title: "主人公になろう！", tieIn: "feat.鈴木愛理", slug: "shujinkou-ni-narou", image: "shujinkou-ni-narou" },
  { group: "オーイシマサヨシ", type: "シングル", date: "2025.01", title: "L'oN", slug: "lon", image: "lon" },
  {
    group: "オーイシマサヨシ",
    type: "シングル",
    date: "2025.03",
  ...
  { group: "オーイシマサヨシ", type: "シングル", date: "2025.03", title: "君じゃなきゃダメみたい – From THE FIRST TAKE", note: "THE FIRST TAKE配信", slug: "kimi-janakya-dame-mitai-first-take", image: "kimi-janakya-dame-mitai-first-take" },
  ...
  { group: "オーイシマサヨシ", type: "映像", date: "2024.08", title: "オーイシ武道館 〜オーイシマサヨシ ワンマンライブ at 日本武道館〜", slug: "oishi-budokan", image: "oishi-budokan" },
